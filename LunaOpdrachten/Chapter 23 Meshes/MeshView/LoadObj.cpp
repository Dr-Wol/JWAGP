...
void ObjLoader::ReadMaterials(std::ifstream& fin, UINT numMaterials, std::vector<ObjMaterial>& mats)
{
	std::string ignore;
...
void ObjLoader::ReadSubsetTable(std::ifstream& fin, UINT numSubsets, std::vector<MeshGeometry::Subset>& subsets)
{
	std::string ignore;
...
void ObjLoader::ReadVertices(std::ifstream& fin, UINT numVertices, std::vector<Vertex::PosNormalTexTan>& vertices)
{
	std::string ignore;
...
void ObjLoader::ReadTriangles(std::ifstream& fin, UINT numTriangles, std::vector<USHORT>& indices)
{
	std::string ignore;
