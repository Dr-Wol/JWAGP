  ...
  mTheta(1.3f*MathHelper::Pi), mPhi(0.4f*MathHelper::Pi), mRadius(80.0f)
{
	...
	mDirLights[2].Ambient  = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	mDirLights[2].Diffuse  = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	mDirLights[2].Specular = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
...
bool BlendApp::Init()
{
	...
	HR(D3DX11CreateShaderResourceViewFromFile(md3dDevice, 
		L"Textures/Vuurgras.dds", 0, 0, &mGrassMapSRV, 0 ));

	HR(D3DX11CreateShaderResourceViewFromFile(md3dDevice, 
		L"Textures/Blauw Water.dds", 0, 0, &mWavesMapSRV, 0 ));
