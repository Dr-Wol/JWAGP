  ...
  mInputLayout(0), mEyePosW(0.0f, 0.0f, 0.0f), mTheta(1.5f*MathHelper::Pi), mPhi(0.1f*MathHelper::Pi), mRadius(80.0f)
{
	...
	//
	//
	//	The Specular lighting is altered here, higher numbers give a brighter light
	//
	//
	//
	//
	...
	mDirLight.Specular = XMFLOAT4(51.0f, 51.0f, 51.0f, 1.0f);
	mDirLight.Direction = XMFLOAT3(0.57735f, -0.57735f, 0.57735f);
 
	// Point light--position is changed every frame to animate in UpdateScene function.
	mPointLight.Ambient  = XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f);
	mPointLight.Diffuse  = XMFLOAT4(0.7f, 0.7f, 0.7f, 1.0f);
	mPointLight.Specular = XMFLOAT4(56.0f, 56.0f, 56.0f, 1.0f);
...
void LightingApp::DrawScene()
{
	...
	//
	//
	//	The Spot light radius is altered here, higher numbers give a sharper angle so a smaller light
	//
	//
	//
	//
