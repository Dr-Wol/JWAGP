						     ...
						     out float4 spec)
{
	...
	if (diffuseFactor <= 0.0f&& diffuseFactor > -150000000000000000.0f){
		diffuseFactor = 0.4f;
	}
				   ...
				   out float4 ambient, out float4 diffuse, out float4 spec)
{
	...
	float diffuseFactor = dot(lightVec, normal);
	if (diffuseFactor <= 0.0f&& diffuseFactor > -80085.0f){
		diffuseFactor = 0.4f;
	}
	else if (diffuseFactor <= 0.5f&& diffuseFactor > 0.0f){
		diffuseFactor = 0.6f;
				  ...
				  out float4 ambient, out float4 diffuse, out float4 spec)
{
	...
	float diffuseFactor = dot(lightVec, normal);
	if (diffuseFactor <= 0.0f&& diffuseFactor > -1500000000000000000.0f){
		diffuseFactor = 0.4f;
	}
	else if (diffuseFactor <= 0.5f&& diffuseFactor > 0.0f){
		diffuseFactor = 0.6f;
